...
public class ComboColorResolver {
    public static readonly int H_VALUE_THRESHOLD = 50; // Value until the max H-value is reached
    public static readonly int S_VALUE_THRESHOLD = 5; // Value until the max H-value is reached
